...
conversion:
  ...
  size_bytes: 12882
  size_human: 12.6 KB
  conversion_date: '2025-09-23T04:48:06'
  page_count: 4
classification:
  file_metadata:
    filename: ENTITY_EXTRACTION_MD_DOCUMENT.md
  ...
  raw_entities:
    global_entities:
      ...
      - value: Sarah Williams
        span: {start: 651, end: 665}
        text: Sarah Williams
        type: PERSON
      - value: Michael
        span: {start: 737, end: 744}
        text: Michael
        type: PERSON
      - value: Jennifer Martinez
        ...
        type: PERSON
      - value: David Kim
        span: {start: 901, end: 910}
        text: David Kim
        type: PERSON
      - value: Lisa Anderson
        span: {start: 983, end: 996}
        text: Lisa Anderson
        type: PERSON
      - value: James Wilson
      ...
      - value: Yuki Tanaka
        ...
        type: PERSON
      - value: Olga Volkov
        span: {start: 1736, end: 1747}
        text: Olga Volkov
        type: PERSON
      - value: Silva Santos
        span: {start: 1821, end: 1833}
        text: Silva Santos
        type: PERSON
      - value: Van Der Berg
        ...
        type: PERSON
      - value: John John
        span: {start: 2163, end: 2172}
        text: John John
        type: PERSON
      - value: San Antonio
        span: {start: 5069, end: 5080}
        text: San Antonio
        type: PERSON
      - value: San Diego
        span: {start: 5086, end: 5095}
        text: San Diego
        type: PERSON
      - value: San Jose
        span: {start: 5117, end: 5125}
        text: San Jose
        type: PERSON
      - value: John Smith
  ...
  entity_insights:
    ...
    total_entities_found: 440
    entity_density: 36.666666666666664
  performance:
    processing_time_ms: 791.86
    ...
    layer_timings_ms:
      ...
      layer2_document_structure: 0.44
      layer3_domain_classification: 1.05
      layer4_entity_extraction: 620.79
      layer6_semantic_facts: 169.51
    early_termination: false
enrichment:
  description: Professional NLP Entity Enrichment
  enrichment_date: '2025-09-23T04:48:07'
...
normalization:
  ...
  processing_time_ms: 1.1510070180520415
  statistics:
    processing_time_ms: 1.1510070180520415
    ...
    total_mentions: 27
    performance_metrics: {entities_per_ms: 23.45771969809069, memory_efficient: true, edge_compatible: true}
  canonical_entities:
  - id: d001
    type: DATE
  ...
  - id: d027
    ...
    metadata:
      ...
      day: 23
  entity_reduction_percent: 86.15384615384616
  performance: {entities_per_ms: 23.45771969809069, edge_compatible: true}
---
