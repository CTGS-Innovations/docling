...
conversion:
  ...
  size_bytes: 12882
  size_human: 12.6 KB
  conversion_date: '2025-09-23T04:44:21'
  page_count: 4
classification:
  file_metadata:
    filename: ENTITY_EXTRACTION_MD_DOCUMENT.md
  ...
  entity_insights:
    ...
    total_entities_found: 436
    entity_density: 36.333333333333336
  performance:
    processing_time_ms: 779.53
    ...
    layer_timings_ms:
      ...
      layer3_domain_classification: 1.03
      layer4_entity_extraction: 628.87
      layer6_semantic_facts: 149.1
    early_termination: false
enrichment:
  description: Professional NLP Entity Enrichment
  enrichment_date: '2025-09-23T04:44:22'
...
normalization:
  ...
  processing_time_ms: 1.1925300350412726
  statistics:
    processing_time_ms: 1.1925300350412726
    ...
    total_mentions: 27
    performance_metrics: {entities_per_ms: 22.64093918528899, memory_efficient: true, edge_compatible: true}
  canonical_entities:
  - id: d001
    type: DATE
  ...
  - id: d027
    ...
    metadata:
      ...
      day: 23
  entity_reduction_percent: 86.15384615384616
  performance: {entities_per_ms: 22.64093918528899, edge_compatible: true}
---
